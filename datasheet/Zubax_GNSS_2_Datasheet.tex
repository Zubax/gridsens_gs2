...
\begin{itemize}
    \item GNSS fix quality is below the configured threshold (section \ref{configuration_parameters})
    (disabled by default).
...
\subsection{Hardware version 2.1 and older}
...
\chapter{Configuration parameters}\label{configuration_parameters}
