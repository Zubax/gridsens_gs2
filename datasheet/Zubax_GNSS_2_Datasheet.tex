...
\begin{description}
    ...
    \item[X] One or more decimal digits.
\end{description}

\subsubsection{RMC}

The RMC sentence contains the recommended minimum set of GNSS solution data.

Format: \verb|$__RMC,xxxxxx.xx,a,xxxx.X,a,xxxxx.X,a,X.X,X.X,xxxxxx,X.X,a*|
...
\begin{ZubaxSimpleTable}{RMC sentence fields}{|l l X|}
    ...
    3  & xxxx.X       & Geographical latitude. The first two digits represent angular degrees,
                        the following digits represent angular minutes with the fractional part. \\
    4  & a            & Related to the previous field. N -- north, S -- south. \\
    5  & xxxxx.X      & Geographical longitude. The first three digits represent angular degrees,
                        the following digits represent angular minutes with the fractional part. \\
    6  & a            & Related to the previous field. E -- east, W -- west. \\
    7  & X.X          & Speed over ground, knots. \\
    8  & X.X          & Track angle relative to the true north, angular degrees. \\
    9  & xxxxxx       & Date in the format \texttt{ddmmyy}. \\
    10 & X.X          & Magnetic variation, angular degrees. This field is optional. \\
...
Format: \verb|$__GGA,xxxxxx.xx,xxxx.X,a,xxxxx.X,a,x,xx,X.X,X.X,a,X.X,a,X.X,xxxx*|
...
\begin{ZubaxSimpleTable}{GGA sentence fields}{|l l X|}
    \# & Format       & Purpose \\
    1  & xxxxxx.xx    & UTC time as \texttt{hhmmss} followed by dot, followed by hundredths of the second. \\
    2  & xxxx.X       & Geographical latitude. The first two digits represent angular degrees,
                        the following digits represent angular minutes with the fractional part. \\
    3  & a            & Related to the previous field. N -- north, S -- south. \\
    4  & xxxxx.X      & Geographical longitude. The first three digits represent angular degrees,
                        the following digits represent angular minutes with the fractional part. \\
    ...
    9  & X.X          & Altitude relative to the mean sea level (MSL altitude), meters. \\
    10 & a            & Units of the previous field: M -- meters. \\
    11 & X.X          & Geoidal separation, which is the difference between the WGS-84 earth ellipsoid and
    ...
    13 & X.X          & Age of the differential GNSS data.
                        Empty field means that the differential data has never been available. \\
    13 & xxxx         & Differential reference station identifier, 0000--1023.
                        Empty field means that the differential data has never been available. \\
\end{ZubaxSimpleTable}
...
\begin{ZubaxSimpleTable}{ sentence fields}{|l l X|}
    \# & Format       & Purpose \\
    1  &              &  \\
    2  &              &  \\
    3  &              &  \\
