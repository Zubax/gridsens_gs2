...
\begin{description}
    ...
    \begin{enumerate}
        ...
        \item ECEF-X velocity error variance, in $\frac{\text{meters}}{\text{second}}^2$.
        \item ECEF-Y velocity error variance, in $\frac{\text{meters}}{\text{second}}^2$.
        \item ECEF-Z velocity error variance, in $\frac{\text{meters}}{\text{second}}^2$.
    \end{enumerate}
\end{description}
